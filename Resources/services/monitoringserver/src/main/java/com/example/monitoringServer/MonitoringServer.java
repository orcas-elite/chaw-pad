...
public class MonitoringServer {
	...
	public static void main(final String[] args) {
		...
		final Configuration mrlfConfig = new Configuration();
		mrlfConfig.setProperty(MonitoringRecordLoggerFilter.CONFIG_PROPERTY_NAME_MONITORING_PROPS_FN, "kieker.monitoring.properties");
		final MonitoringRecordLoggerFilter mrlf = new MonitoringRecordLoggerFilter(mrlfConfig, analysisController);
