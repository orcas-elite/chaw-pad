...
public class Injector implements Runnable, ControlApi {
    ...
    private static final String EVALUATION_SCENARIO = "CASSANDRA";
    ...
    public void run() {
        ...
        try {
            ...
            if(EVALUATION_SCENARIO.equals("SIMPLE")) {
                ...
                MicroserviceRealMethodLevelAnomalyInjection realLogicDoOrder = new MicroserviceRealMethodLevelAnomalyInjection("logic", "doOrder", 25000, 300);
    ...
    public void addAnomaly(MicroserviceRealAnomalyInjection anomalyInjection) {
        restTemplate.postForObject(BASE_URL + "/realAnomaly", anomalyInjection, Object.class);
        anomalyInjection.printEvent();
    }
