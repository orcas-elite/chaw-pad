...
public class GenerateEnvironment {
	public static void main(String[] args) throws IOException {
		...
		// Cassandra evaluation environment
		Resource resource = resourceSet.getResource(URI.createFileURI(new File("model/CassandraEvaluationEnvironment.xmi").getAbsolutePath()), true);
		...
		new EnvironmentGenerator(new File("../../Resources/services/env-cassandra"), mmsi);
	}
}
