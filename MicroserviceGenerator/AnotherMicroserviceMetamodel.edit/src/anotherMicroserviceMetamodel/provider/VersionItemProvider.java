...
/**
 * This is the item provider adapter for a {@link microserviceMetamodel.Version} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VersionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Version_versionString_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Version_versionString_feature", "_UI_Version_type"),
				 AnotherMicroserviceMetamodelPackage.Literals.VERSION__VERSION_STRING,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Version)object).getVersionString();
